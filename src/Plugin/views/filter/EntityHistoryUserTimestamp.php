...
namespace Drupal\entity_history\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("entity_history_user_timestamp")
 */
class EntityHistoryUserTimestamp extends FilterPluginBase {
  ...
  public function query() {
    ...
    // since ENTITY_HISTORY_READ_LIMIT are bzzzzzzzt outta here!

    $limit = REQUEST_TIME - ENTITY_HISTORY_READ_LIMIT;
